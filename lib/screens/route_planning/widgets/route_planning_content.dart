...
import 'route_planning_setup_view.dart';
...
class RoutePlanningPageContentState extends State<RoutePlanningPageContent> {
  ...
  void toggleAllCustomers(List<CustomerRecord> customersWithCoords, bool selectAll) {
    setState(() {
      if (selectAll) {
        for (final c in customersWithCoords) {
    ...
    for (int i = 0; i < _remainingQueue.length; i++) {
      ...
      markers.add(
        Marker(
          ...
          child: _buildPinMarker(
            color: isActive ? const Color(0xFFF9BE00) : const Color(0xFF33BCB4),
  ...
  Widget _buildClusterMarker({
    ...
    final color = allSelected
        ? const Color(0xFFF9BE00) // Amber if all selected
        : const Color(
            0xFF33BCB4,
          ...
          Marker(
            ...
            child: GestureDetector(
              ...
              child: Opacity(
                ...
                child: _buildPinMarker(
                  color: isSelected
                      ? const Color(0xFFF9BE00) // Selected: Amber
                      : const Color(0xFF33BCB4), // Unselected: Teal
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  shape: BoxShape.circle,
                  border: Border.all(
                    color: const Color(0xFF33BCB4).withValues(alpha: 0.2),
                    width: 4,
                  ),
                ),
                child: const Icon(
